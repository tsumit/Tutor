                ...
                <div id="respond" class="comment-respond contact style2">
                    ...
                    <form  class="flat-contact-form style2 bg-dark height-small" method="post" >
                        <div class="field clearfix">      
                            <div class="wrap-type-input">                    
                                ...
                                <div class="input-wrap last Subject">
                                    <input type="text" value="" placeholder="Subject (Optinal)" name="subject" id="subject" required>
                                </div>  
                            </div>
                        ...
                        <div class="submit-wrap">
                            <input type="submit" name="submit" value="Send Your Message" class="flat-button bg-orange">
                        </div>
                    </form><!-- /.comment-form --> 
 <?php               	
						...
						$message=$_POST["message"];
												 ...
												 $query1="insert into enquiry set name='$name',email='$email',time='$enter_time',date='$enter_date',subject='$subject',message='$message'";
